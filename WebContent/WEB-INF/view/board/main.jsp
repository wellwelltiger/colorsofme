...
<section class="naviforms">
  ...
  <section class="topform">
	...
	<c:forEach var='sub_list' items="${list }" varStatus="idx">
                <div class="paylist" style="margin-top:20px">
                    <div class="card shadow">
                        <div class="payforms">
                            ...
                            <a href="${root }board/main2?board_info_idx=${board_list[idx.index].board_info_idx}"><button class="morebtn">더보기</button></a>
                        </div>
                    </div>
                </div>
...
<section class="question">
    ...
    <div class="plusbtn">
      ...
      <div class = "faq2">
        <ul>
          <li class="m_li">
            <p><button class="qnabtn"><h3>Q. 과일어카운트계정에 대한 문의는 어디로 하나요?</h3></button></p>
              <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
          </li>
        </ul>
      </div>
      <div class="faq2">
        <ul>
          <li class="m_li">
            <p><button class="qnabtn"><h3>Q. 지금 무슨생각 하시나요</h3></button></p>
              <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
          </li>
        </ul>
      </div>
      <div class="faq2">
        <ul>
          <li class="m_li">
            <p><button class="qnabtn"><h3>Q. 결제 옵션에는 어떤 것이 있나요?</h3></button></p>
              <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
          </li>
        </ul>
      </div>
      <div class="faq2">
        <ul>
          <li class="m_li">
            <p><button class="qnabtn"><h3>Q. Apple은 지역 할인을 적용해주나요?</h3></button></p>
              <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
          </li>
        </ul>
      </div>
        <div class="faq2">
          <ul>
            <li class="m_li">
              <p><button class="qnabtn"><h3>Q. 할부 옵션에는 어떤 것이 있나요?</h3></button></p>
                <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
            </li>
          </ul>
        </div>
        <div class="faq2">
          <ul>
            <li class="m_li">
              <p><button class="qnabtn"><h3>Q. 자택이 아닌 곳으로 제품을 배송받을 수 있나요?</h3></button></p>
                <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
            </li>
          </ul>
        </div>
        <div class="faq2">
          <ul>
            <li class="m_li">
              <p><button class="qnabtn"><h3>Q. 과일맛있다블라블라블라 </h3></button></p>
              <div class="cont">A. 삼성 서비스 이용을 위한 회원가입/로그인 등 삼성계정 관련 문의는 ☎ 1588-3366으로 문의하시기 바랍니다.</div>
            </li>
          </ul>
        </div>
